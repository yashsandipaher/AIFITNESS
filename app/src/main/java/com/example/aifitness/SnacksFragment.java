...
public class SnacksFragment extends Fragment {
    ...
    private GridLayout snackGridLayout;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        snackGridLayout = view.findViewById(R.id.snackGridLayout);
                        ...
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot document : task.getResult()) {
                                if (document.exists()) {
                                    ...
                                    String breakfast = document.getString("snacks");
...
//                                    addBreakfastItemsToGridLayout(breakfastItems);
    ...
    private void addBreakfastItemsToGridLayout(String[] breakfastItems) {
        for (String item : breakfastItems) {
            ...
            snackGridLayout.addView(textView);
        }
    }
}