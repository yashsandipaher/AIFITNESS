...
public class LunchFragment extends Fragment {
    ...
    private GridLayout lunchGridLayout;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lunchGridLayout = view.findViewById(R.id.lunchGridLayout);
                        ...
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot document : task.getResult()) {
                                if (document.exists()) {
                                    ...
                                    String breakfast = document.getString("lunch");
...
//                                    addBreakfastItemsToGridLayout(breakfastItems);
    ...
    private void addBreakfastItemsToGridLayout(String[] breakfastItems) {
        for (String item : breakfastItems) {
            ...
            lunchGridLayout.addView(textView);
        }
    }
}