...
public class DinnerFragment extends Fragment {
    ...
    private GridLayout dinnerGridLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dinnerGridLayout = view.findViewById(R.id.dinnerGridLayout);
                        ...
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot document : task.getResult()) {
                                if (document.exists()) {
                                    ...
                                    String breakfast = document.getString("dinner");
...
//                                    addBreakfastItemsToGridLayout(breakfastItems);
    ...
    private void addBreakfastItemsToGridLayout(String[] breakfastItems) {
        for (String item : breakfastItems) {
            ...
            dinnerGridLayout.addView(textView);
        }
    }
